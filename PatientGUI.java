...
public class PatientGUI {
	...
	private void initialize() {
		...
		frame.getContentPane().add(tabbedPane, "name_10322174189547");
		...
		textArea.setBounds(77, 122, 509, 297);
		...
		lblAccountInformation.setBounds(230, 90, 190, 27);
		...
		welcomeLabel.setForeground(SystemColor.textHighlight);
		welcomeLabel.setFont(new Font("Consolas", Font.BOLD, 17));
		welcomeLabel.setBounds(22, 11, 190, 27);
		AccountInformation.add(welcomeLabel);
		...
		scrollPane.setBounds(73, 29, 157, 101);
		...
		btnBloodPressure.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Chart bloodPressureChart = new Chart(Globals.BLOODPRESSURE,
						Globals.BARCHART3D, (Patient) Globals.userDatabase
								.getCurrentUser());
		...
		btnWeightLineChart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Chart weightLineChart = new Chart(Globals.WEIGHT,
						Globals.LINECHART, (Patient) Globals.userDatabase
								.getCurrentUser());
		...
		btnWeightBarChart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Chart weightBarChart = new Chart(Globals.WEIGHT,
						Globals.BARCHART, (Patient) Globals.userDatabase
								.getCurrentUser());
				weightBarChart.pack();
		...
		informationDisplay2.setBounds(98, 11, 510, 205);
		informationDisplay2.setText(Globals.userDatabase.getCurrentUser()
				.print());
		informationDisplay2.setFont(new Font("Monospaced", Font.BOLD, 13));
		...
		btnRefresh.setIcon(new ImageIcon(PatientGUI.class
				.getResource("/images/refresh_icon&32.png")));
		...
		btnRefresh.setBounds(618, 6, 51, 44);
		...
		btnBack.setBorder(new BevelBorder(BevelBorder.RAISED, Color.LIGHT_GRAY,
				null, null, null));
		...
		btnEnter.setFont(new Font("Monospaced", Font.PLAIN, 16));
				...
				if (doubleArray != null) {
					...
					if (tempUser instanceof Patient) {
						...
						JOptionPane.showOptionDialog(null,
								...
								"Form Submitted", JOptionPane.DEFAULT_OPTION,
		...
		btnCancel.setBorder(new BevelBorder(BevelBorder.RAISED, new Color(160,
		...
		menuSave.setIcon(new ImageIcon(PatientGUI.class
		...
		menuNewEntry.setIcon(new ImageIcon(PatientGUI.class
				.getResource("/images/doc_plus_icon&16.png")));
		...
		menuEditAccount.setIcon(new ImageIcon(PatientGUI.class
		...
		menuLogout.setIcon(new ImageIcon(PatientGUI.class
